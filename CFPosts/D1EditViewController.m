...
{
    NSArray *myPhotoAray = [[NSArray alloc] initWithObjects:self.userNameTextField.text,self.titleTextField.text,self.contentTextField.text,self.remoteIDOfEdited, self.myImageBox.image, nil];
